//
//  GYSelectWaterViewController.swift
//  GY_app_ios
//
...
class GYSelectWaterViewController: ZEJBottomPresentViewController {
...
extension GYSelectWaterViewController:UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell:GYSelectWaterCell? = tableView.dequeueReusableCell(withIdentifier: GYSelectWaterCell.indentifier) as? GYSelectWaterCell
        ...
        if dataArray.count != 0 {
            ...
            for temp in tempArray {
                ...
                if dic["name"] as! String == dicc["name"] as! String {
