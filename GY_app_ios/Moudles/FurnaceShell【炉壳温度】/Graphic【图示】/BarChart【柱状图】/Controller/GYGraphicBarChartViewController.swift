...
class GYGraphicBarChartViewController: GYViewController {
...
extension GYGraphicBarChartViewController {
    func setupViews() {
        self.title = "柱状图"
...
extension GYGraphicBarChartViewController {
    ...
    func requestnextdata(array:NSArray){
        ...
        let params = ["start_time":currentLastHourDateString + ":00","end_time":currentDateString + ":00","device_db":GYDeviceData.default.device_db,"idString":partid,"type":1] as [String : Any]
...
extension GYGraphicBarChartViewController:UIPickerViewDelegate,UIPickerViewDataSource,AAChartViewDelegate {
...
extension GYGraphicBarChartViewController:LMJDropdownMenuDelegate,LMJDropdownMenuDataSource{
