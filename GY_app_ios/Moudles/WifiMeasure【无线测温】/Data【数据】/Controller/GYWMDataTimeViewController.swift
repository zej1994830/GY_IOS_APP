//
//  GYWMDataTimeViewController.swift
//  GY_app_ios
//
//  Created by zhaoenjia on 2024/6/6.
//

import UIKit
import SpreadsheetView

class GYWMDataTimeViewController: GYViewController {
    ...
    private lazy var nameBtn:UIButton = {
        ...
        btn.imageEdgeInsets = UIEdgeInsets(top: 0, left: 140, bottom: 0, right: -25)
...
extension GYWMDataTimeViewController {
    func setupViews() {
        self.title = "数据"
...
//                    let startIndex = str2!.index(str2!.startIndex, offsetBy: 5)
    ...
    func requestnextdata(array:NSArray){
        ...
        GYNetworkManager.share.requestData(.get, api: Api.getcwsntimedata, parameters: params) {[weak self] (result) in
            guard let weakSelf = self else{
                return
            }
...
extension GYWMDataTimeViewController:UIPickerViewDelegate,UIPickerViewDataSource {
...
extension GYWMDataTimeViewController: SpreadsheetViewDataSource, SpreadsheetViewDelegate{
...
extension GYWMDataTimeViewController:LMJDropdownMenuDelegate,LMJDropdownMenuDataSource{
